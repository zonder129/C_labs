 ...
 implements Cell.StationOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("sendSMSToDB", new java.lang.Integer (1));
    _methods.put ("sendSMSToTube", new java.lang.Integer (2));
    _methods.put ("setServerDBRef", new java.lang.Integer (3));
    _methods.put ("setStationName", new java.lang.Integer (4));
  }
  ...
  /* Отправить сообщение message от номера fromNum к номеру toNum */
       case 1:  // Cell/Station/sendSMSToDB
       {
         String fromNum = in.read_string ();
         String toNum = in.read_string ();
         String message = in.read_string ();
         int $result = (int)0;
         $result = this.sendSMSToDB (fromNum, toNum, message);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 2:  // Cell/Station/sendSMSToTube
       {
         String fromNum = in.read_string ();
         String toNum = in.read_string ();
         String message = in.read_string ();
         int $result = (int)0;
         $result = this.sendSMSToTube (fromNum, toNum, message);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 3:  // Cell/Station/setServerDBRef
       {
         Cell.ServerDB objRef = Cell.ServerDBHelper.read (in);
         int $result = (int)0;
         $result = this.setServerDBRef (objRef);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }

       case 4:  // Cell/Station/setStationName
       {
         String stationName = in.read_string ();
         int $result = (int)0;
         $result = this.setStationName (stationName);
         out = $rh.createReply();
         out.write_long ($result);
         break;
       }
